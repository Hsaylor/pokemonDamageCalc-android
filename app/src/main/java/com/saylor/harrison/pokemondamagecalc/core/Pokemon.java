...
public class Pokemon {
	...
	public static Pokemon
			venusaur = new Pokemon("Venusaur", Type.GRASS, Type.POISON, 80, 82, 83, 100, 100, 80, Ability.OVERGROW);
	public static Pokemon
			tar = new Pokemon("Tyranitar", Type.ROCK, Type.DARK, 100, 134, 110, 95, 100, 61, Ability.SANDSTREAM);
